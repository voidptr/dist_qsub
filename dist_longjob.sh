    ...
    then
        ...
        then
            ...
            then
                ...
                echo sbatch -H -C $CONSTRAINT -J $sname -o ${DEST_DIR}/${JOBNAME}_message.log_%a --array=$JOBSEEDS -c $PPN --mem=$MEM --time=$TIME --mailuser=$MAILUSER
                sbatch -H -C $CONSTRAINT -J $sname -o ${DEST_DIR}/${JOBNAME}_message.log_%a --array=$JOBSEEDS -c $PPN --mem=$MEM --time=$TIME --mailuser=$MAILUSER
